class DeCraftCarrierComplete extends RecipeBase
{	
	override void Init()
	{
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"PlateCarrierComplete");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("PlateCarrierBlank");//add results here
		...
		//result2
		AddResult("CarrierHolsterSolo");//add results here
		...
		//result3
		AddResult("CarrierPouches");//add results here
