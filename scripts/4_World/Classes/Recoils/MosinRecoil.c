class MosinRecoil: RecoilBase
{
	override void Init()
	{
		...
		m_HandsCurvePoints.Insert("0 2 0");
		...
		m_MouseOffsetRelativeTime = 0.03;//[0..1] a time it takes to move the mouse the required distance relative to the reload time of the weapon(firing mode)
	}
}