class ActionBuildBasePartCB : ActionContinuousBaseCB
{
...
class ActionBuildBasePart: ActionContinuousBase
{
	void ActionBuildBasePart()
	{
		m_CallbackClass = ActionBuildBasePartCB;
