class ActionDismantleBasePartCB : ActionContinuousBaseCB
{
...
class ActionDismantleBasePart: ActionContinuousBase
{
	void ActionDismantleBasePart()
	{
		m_CallbackClass = ActionDismantleBasePartCB;
