class Mp5kRecoil: RecoilBase
{
	...
	{		
		...
		vector point_3;
		vector point_4;
		point_1[0] = Math.RandomFloatInclusive(0.5,1.5); point_1[1] = 1.5; point_1[2] = 0;
		point_2[0] = Math.RandomFloatInclusive(-1,1); point_2[1] = 2; point_2[2] = 0;
		point_3[0] = Math.RandomFloatInclusive(-0.75,-1.75); point_3[1] = 1.5; point_3[2] = 0;
