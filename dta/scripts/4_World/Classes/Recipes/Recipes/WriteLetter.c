...
{	
	override void Init()
	{
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"Pen_ColorBase");//you can insert multiple ingredients this way
	...
	{
		//probably should be limited by number/length of strings already present, or worsening condition of the paper in question?
		return true;
	}
