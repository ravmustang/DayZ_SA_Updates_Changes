...
class CZ527_Base : BoltActionRifle_Base
{
	...
	override void InitStateMachine()
	{
		...
		m_fsm.AddTransition(new WeaponTransition(Mech_CF0, _abt_,    CF0, NULL, new WeaponGuardChamberFiredOut(this)));
		...
		m_fsm.AddTransition(new WeaponTransition(   Mech_CF1, _fin_ , C01, NULL, new WeaponGuardChamberEmpty(this)));
		m_fsm.AddTransition(new WeaponTransition(   Mech_CF1, _fin_ , C11));
		m_fsm.AddTransition(new WeaponTransition(   Mech_CF1, _abt_ , CF1, NULL, new WeaponGuardChamberFiredOut(this)));
		m_fsm.AddTransition(new WeaponTransition(   Mech_CF1, _abt_ , C01, NULL, new WeaponGuardChamberEmpty(this)));
		...
		m_fsm.AddTransition(new WeaponTransition(Chamber_CF0, _abt_ , CF0, NULL, new WeaponGuardChamberFiredOut(this) ));
		m_fsm.AddTransition(new WeaponTransition(Chamber_CF0, _abt_ , C00, NULL, new WeaponGuardChamberEmpty(this) ));
		...
		m_fsm.AddTransition(new WeaponTransition(Chamber_CF1, _abt_ , CF1, NULL, new WeaponGuardChamberFiredOut(this) ));
		m_fsm.AddTransition(new WeaponTransition(Chamber_CF1, _abt_ , C01, NULL, new WeaponGuardChamberEmpty(this) ));
		...
		m_fsm.AddTransition(new WeaponTransition(Attach_CF0, _fin_,    C01, NULL, new WeaponGuardChamberEmpty(this)));
		m_fsm.AddTransition(new WeaponTransition(Attach_CF0, _fin_,    C11));
		
		m_fsm.AddTransition(new WeaponTransition(Attach_CF0, _abt_,    CF1, NULL, new WeaponGuardChamberFiredOut(this)));
		m_fsm.AddTransition(new WeaponTransition(Attach_CF0, _abt_,    C11, NULL, new WeaponGuardChamberFull(this)));
		...
		m_fsm.AddTransition(new WeaponTransition(   CF1, __S__, Reload_CF1)); // swap in CLO/b0/m1
		m_fsm.AddTransition(new WeaponTransition(Reload_CF1, _fin_,   C01, NULL, new WeaponGuardChamberEmpty(this)));
		m_fsm.AddTransition(new WeaponTransition(Reload_CF1, _fin_,   C11));
		m_fsm.AddTransition(new WeaponTransition(Reload_CF1, _abt_,    CF1, NULL, new WeaponGuardChamberFiredOut(this)));
		m_fsm.AddTransition(new WeaponTransition(Reload_CF1, _abt_,    C11, NULL, new WeaponGuardChamberFull(this)));
		...
		m_fsm.AddTransition(new WeaponTransition(   Unjam_JF1, _fin_,    C01, NULL, new WeaponGuardChamberEmpty(this)));
